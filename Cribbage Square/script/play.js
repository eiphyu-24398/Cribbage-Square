...
function twentyfive(){
    ...
    scoreName(scroeNamesList);
    document.getElementById('player2').innerHTML='Score :'+p2_scroll;
    document.getElementById('p1_final').innerHTML="Delar Score :"+p1_scroll;
    document.getElementById('p2_final').innerHTML="Non-Delar Score :"+p2_scroll;
    let winner=document.getElementById('winner');
    if(p1_scroll>p2_scroll){
        winner.innerHTML ="Delar Win"
    }else{
        winner.innerHTML ="Non-Delar Win"
    }
    popup();
}
}